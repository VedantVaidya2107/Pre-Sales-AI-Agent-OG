...
async def main():
    ...
    if not (url and key and secret):
        print("Error: Missing LiveKit credentials (LIVEKIT_URL, LIVEKIT_API_KEY, LIVEKIT_API_SECRET)")
        return
    ...
    try:
        ...
        print("\nIMPORTANT: Please copy the Trunk ID above and set it as VOBIZ_SIP_TRUNK_ID in your .env")
